...
export class SecurityManager {
  ...
  async registerUser({ username, displayName, email, oab, password }) {
    ...
    const isMaster = normalizedEmail === 'ricardo.rossetto.adv@gmail.com';
    const newUser = {
      ...
      oab: String(oab || '').trim(),
      role: isMaster ? 'master_admin' : 'collaborator',
    ...
    return {
      ...
      message: isMaster
        ? 'Conta do Administrador Master ativada com sucesso!'
        : 'Solicitação de cadastro registrada com sucesso! Seu acesso está pendente de aprovação pelo Administrador Master (Dr. Ricardo Rossetto - ricardo.rossetto.adv@gmail.com).'
    };
  }
